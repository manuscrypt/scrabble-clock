			...
			},
			{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$class('pie-passed'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
...
var _user$project$View_Settings$timeButton = F3(
...
var _user$project$View_Settings$secs = function (x) {
...
var _user$project$View_Settings$challenges = function (model) {
	return A2(
		_elm_lang$core$List$map,
		function (s) {
			return A3(_user$project$View_Settings$timeButton, s, model.config.challenge, _user$project$Types$Challenge);
		},
		A2(
			_elm_lang$core$List$map,
			_user$project$View_Settings$secs,
			{
				ctor: '::',
				_0: 25,
				_1: {
...
var _user$project$View_Settings$overtimes = function (model) {
	return A2(
		_elm_lang$core$List$map,
		function (s) {
			return A3(_user$project$View_Settings$timeButton, s, model.config.overtime, _user$project$Types$Overtime);
		},
		A2(
			_elm_lang$core$List$map,
			_user$project$View_Settings$secs,
...
var _user$project$View_Settings$durations = function (model) {
	return A2(
		_elm_lang$core$List$map,
		function (s) {
			return A3(_user$project$View_Settings$timeButton, s, model.config.duration, _user$project$Types$Duration);
		},
		A2(
			_elm_lang$core$List$map,
			_user$project$View_Settings$secs,
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p2.ctor) {
			...
			case 'ResetSwipe':
				var _p6 = _p2._0;
				var _p5 = _user$project$Main$getCoord(_p6);
				var x = _p5.x;
				var y = _p5.y;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{
							resetGesture: A2(_zwilias$elm_touch_events$Touch$record, _p6, model.resetGesture),
							resetButtonPos: {
								ctor: '_Tuple2',
								_0: x,
								_1: _elm_lang$core$Basics$toFloat(model.size.height) / 2
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							player: function () {
								...
								if (_p9.ctor === 'None') {
									return _elm_lang$core$Native_Utils.eq(_p12, _user$project$Types$PlayerOne) ? _user$project$Types$PlayerTwo : _user$project$Types$PlayerOne;
								} else {
									var _p10 = _p12;
									switch (_p10.ctor) {
										case 'None':
